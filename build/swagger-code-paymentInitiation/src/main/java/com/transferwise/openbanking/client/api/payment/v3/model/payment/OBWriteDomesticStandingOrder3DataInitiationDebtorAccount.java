 ...
 */
@Schema(description = "Provides the details to identify the debtor account.")

public class OBWriteDomesticStandingOrder3DataInitiationDebtorAccount implements Serializable{
  ...
  public OBWriteDomesticStandingOrder3DataInitiationDebtorAccount schemeName(OBExternalAccountIdentification4Code schemeName) {
