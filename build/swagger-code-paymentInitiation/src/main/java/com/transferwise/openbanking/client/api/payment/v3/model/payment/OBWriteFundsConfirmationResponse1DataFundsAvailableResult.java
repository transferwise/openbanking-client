 ...
 */
@Schema(description = "Result of a funds availability check.")
...
public class OBWriteFundsConfirmationResponse1DataFundsAvailableResult implements Serializable{
  ...
  **/
  @Schema(required = true, description = "Date and time at which the funds availability check was generated.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  **/
  @Schema(required = true, description = "Flag to indicate the availability of funds given the Amount in the consent request.")
