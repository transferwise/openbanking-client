 ...
 */
@Schema(description = "Further detailed information on the exchange rate that has been used in the payment transaction.")
...
public class OBWriteInternationalConsentResponse6DataExchangeRateInformation implements Serializable{
  ...
  **/
   ...
   * @return exchangeRate
  **/
  @Schema(required = true, description = "The factor used for conversion of an amount from one currency to another. This reflects the price at which one currency was bought with another currency.")
  ...
  **/
  @Schema(description = "Specified date and time the exchange rate agreement will expire.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
