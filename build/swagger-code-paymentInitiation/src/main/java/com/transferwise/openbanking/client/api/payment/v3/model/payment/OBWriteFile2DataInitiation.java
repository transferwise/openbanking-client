 ...
 */
@Schema(description = "The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds using a payment file.")
...
public class OBWriteFile2DataInitiation implements Serializable{
   ...
   * @return fileType
  **/
  @Schema(required = true, description = "Specifies the payment file type.")
   ...
   * @return fileHash
  **/
  @Schema(required = true, description = "A base64 encoding of a SHA256 hash of the file to be uploaded.")
  ...
  **/
  @Schema(description = "Reference for the file.")
  ...
  **/
  @Schema(description = "Number of individual transactions contained in the payment information group.")
   ...
   * @return controlSum
  **/
  @Schema(description = "Total of all individual amounts included in the group, irrespective of currencies.")
  ...
  **/
  @Schema(description = "Date at which the initiating party requests the clearing agent to process the payment.  Usage: This is the date on which the debtor's account is to be debited.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
