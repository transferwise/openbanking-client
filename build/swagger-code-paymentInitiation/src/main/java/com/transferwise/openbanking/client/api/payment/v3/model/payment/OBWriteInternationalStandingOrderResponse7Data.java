...
import com.transferwise.openbanking.client.api.payment.v3.model.payment.OBWriteInternationalStandingOrderResponse7DataRefund;
...
public class OBWriteInternationalStandingOrderResponse7Data implements Serializable{
  ...
  **/
  @Schema(required = true, description = "OB: Unique identification as assigned by the ASPSP to uniquely identify the international standing order resource.")
