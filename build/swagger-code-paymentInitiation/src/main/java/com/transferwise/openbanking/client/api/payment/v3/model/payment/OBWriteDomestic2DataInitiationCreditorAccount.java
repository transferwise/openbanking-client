 ...
 */
@Schema(description = "Unambiguous identification of the account of the creditor to which a credit entry will be posted as a result of the payment transaction.")

public class OBWriteDomestic2DataInitiationCreditorAccount implements Serializable{
  ...
  public OBWriteDomestic2DataInitiationCreditorAccount schemeName(OBExternalAccountIdentification4Code schemeName) {
  ...
  **/
   ...
   * @return name
  **/
  @Schema(required = true, description = "The account name is the name or names of the account owner(s) represented at an account level. Note, the account name is not the product name or the nickname of the account. OB: ASPSPs may carry out name validation for Confirmation of Payee, but it is not mandatory.")
