 ...
 */
@Schema(description = "Payment status details as per underlying Payment Rail.")
...
public class OBWritePaymentDetailsResponse1DataStatusDetail implements Serializable{
  ...
  **/
   ...
   * @return status
  **/
  @Schema(required = true, description = "Status of a transfer, as assigned by the transaction administrator.")
   ...
   * @return statusReason
  **/
  @Schema(description = "Reason Code provided for the status of a transfer.")
  ...
  **/
  @Schema(description = "Reason provided for the status of a transfer.")
