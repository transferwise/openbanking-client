...
public interface RegistrationClient {
     ...
     *                                                                   to the ASPSP failed
     */
    ClientRegistrationResponse registerClient(
     ...
     *
     * @param clientRegistrationRequest The details (JWT claims) of the new registration request, this MUST contain both the claims to change, and
     ...
     *                                                                   to the ASPSP failed
     */
    ClientRegistrationResponse updateRegistration(
        ClientRegistrationRequest clientRegistrationRequest,
        AspspDetails aspspDetails,
