...
public class RegistrationRequestService {
    ...
    /**
     * Generate the claims for a client registration request to a given ASPSP, which can then be signed and used as the request body for calls to the
     * ASPSP's client registration API.
     *
     * <p>The claims are generated based on the details defined in the supplied {@link SoftwareStatementDetails} and {@link AspspDetails}.
     *
     * <p>The generated claims can then be further modified prior to being signed and sent to the ASPSP.
     *
     ...
     */
    public ClientRegistrationRequest generateRegistrationRequest(
